...
nv.models.line = function() {
    ...
    nv.models.rarefactionLine = function() {
        "use strict";
        //============================================================
        // Public Variables with Default Settings
        //------------------------------------------------------------
            ...
            selection.each(function(data) {
                ...
                groups
                    ...
                    .style('visibility', function(d) {
                        return isArea(d) ? 'hidden' : 'visible';
                    });
                groups.watchTransition(renderWatch, 'line: groups')
                    .style('stroke-opacity', 1)
                    .style('fill-opacity', .5);
    ...
    nv.models.lineRarefactionChart = function() {
        "use strict";
        ...
        var lines = nv.models.rarefactionLine()
            , xAxis = nv.models.axis()
            , yAxis = nv.models.axis()
            , legend = nv.models.legend()
            , interactiveLayer = nv.interactiveGuideline()
                    ...
                    data
                        ...
                        .forEach(function(series,i) {
                            if (!series.hideTooltip) {
                                ...
                                var point;
                                if (rarefactionAddLine && e.pointXValue >= rarefactionAddLine.x_start) {
                                    pointIndex = nv.interactiveBisect(rarefactionAddLine.values, e.pointXValue, chart.x());
                                    point = rarefactionAddLine.values[pointIndex];
                                    lines.highlightPoint(i, series.values.length - 1, true);
                                } else {
                                    pointIndex = nv.interactiveBisect(series.values, e.pointXValue, chart.x());
